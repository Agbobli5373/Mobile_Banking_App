...
@Transactional
class WalletControllerTransferTest {
    ...
    @Test
    void shouldFailWhenRecipientNotFound() throws Exception {
        // Given
    ...
    void shouldFailWithInsufficientFunds() throws Exception {
        ...
        result.andExpect(status().isBadRequest())
                ...
                .andExpect(jsonPath("$.message").value(containsString("Cannot transfer 2000.00: insufficient balance of 1000.00")));
    ...
    void shouldFailWhenTransferringToSelf() throws Exception {
        ...
        result.andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.status").value(400))
                .andExpect(jsonPath("$.message").value(containsString("Cannot transfer money to yourself")));
